  ...
  return (
    <div className="min-h-screen bg-[#0B0C14] text-white p-6 md:p-10">
      <div className="max-w-4xl mx-auto">
        <h1 className="text-3xl font-bold text-rose-500 mb-8">Datos de compra</h1>
      ...
      <div className="mt-4 relative bg-gray-900 border border-gray-700 rounded-xl p-3">
        ...
        />
                ...
                <button
                  ...
                  className="w-full bg-green-800 hover:bg-green-700 disabled:bg-rose-900 disabled:cursor-not-allowed text-white px-6 py-3 rounded-lg font-bold text-lg transition-colors flex items-center justify-center gap-2"
                >
                  {isSubmitting ? (
                    <>
